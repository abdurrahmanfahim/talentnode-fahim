...
const FormLabel = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return <label ref={ref} className={cn("text-sm font-medium", error && "text-destructive", className)} htmlFor={formItemId} {...props} />
})
...
const FormMessage = React.forwardRef(({ className, children, ...props }, ref) => {
  ...
  if (!body) return null
  return <p ref={ref} id={formMessageId} className={cn("text-xs text-destructive", className)} {...props}>{body}</p>
})
